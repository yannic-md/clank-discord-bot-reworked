...
async def main() -> None:
    ...
    async with ClientSession() as web_client:
        async with ClankReworked(commands.when_mentioned, web_client=web_client,
                                 intents=discord.Intents.all()) as bot:
            ...
            try:
                ...
                print("Your bot is using privileged intents from discord, but they are not enabled in the "
